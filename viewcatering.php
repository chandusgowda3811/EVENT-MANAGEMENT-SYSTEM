...
$events = $eventGateway->getEventsBycid($cid);
    ...
    <body>
        ...
        <div class = "content">
            <div class = "container">
                ...
                ?>
                <h2>Events have this catering</h2>
                <table class="table table-hover">
                    <thead>
                        <tr>
                            <th>Event ID</th>
                    ...
                    <tbody>
                        ...
                        while ($row) {
                            ...
                            echo '<td>'
                            . '<a href="viewcatering.php?id='.$row['cid'].'">'.$row['cname'].'</a> '
                            . '</td>';
                            echo '<td>'
                ...
                ?>
                <p>There are no events for this catering.</p>
                <?php
                }
                ?>
